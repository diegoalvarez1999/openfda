...
r1 = conn.getresponse()
# Imprimo la linea de estado de la respuesta para ver que toodo OK, si el estado de respuesta es 200 OK
...
# Puesto que toodo lo de esa URL lo he convertido en un diccionario(recurso), puedo ir iterando sobre sus claves, llegando a la conclusión de que
...
# Por eso me creo una variable que contenga toda la información de mi interes. Que es toodo aquello englobado en 0
infomedica = recurso["results"][0]
# Una vez hecho esto, ya lo tengo toodo, infomedica(la parte que me interesa del JSON)es un diccionario reducido de mi diccionario principal(recurso)
